export default [
    ...
    },
    {
        ...
        children: [
            {
                text: '浏览器环境',
                link: '/interview/browser/inter-page-communication',
                activeMatch: '^/interview/browser',
            },
            {
                text: 'JavaScript',
            ...
            { text: '大模型', link: '/interview/llm/knowledge/rag/', activeMatch: '^/interview/llm' },
            {
                ...
                activeMatch: '^/interview/algorithm',
            },
            {
                text: '前端工程化',
            ...
            {
                text: '问答/编码',
                link: '/interview/coding/program-design/deep-clone',
                activeMatch: '^/interview/coding',
            },
        ],
    },
